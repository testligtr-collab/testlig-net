...
final class Version20260908081322 extends AbstractMigration
{
    ...
    {
        return 'Create reset_password_requests table with cascade delete to users';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE reset_password_requests (id INT AUTO_INCREMENT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL, expires_at DATETIME NOT NULL, user_id BINARY(16) NOT NULL, INDEX IDX_16646B41A76ED395 (user_id), INDEX idx_reset_password_selector (selector), INDEX idx_reset_password_expires_at (expires_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
