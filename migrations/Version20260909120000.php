...
final class Version20260909120000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE curriculum_topics (id BINARY(16) NOT NULL, unit_id BINARY(16) NOT NULL, parent_id BINARY(16) DEFAULT NULL, code VARCHAR(64) NOT NULL, title VARCHAR(180) NOT NULL, normalized_title VARCHAR(180) NOT NULL, position INT NOT NULL, estimated_minutes INT DEFAULT NULL, status VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX uniq_curriculum_topic_unit_code (unit_id, code), UNIQUE INDEX uniq_curriculum_topic_unit_parent_position (unit_id, parent_id, position), UNIQUE INDEX uniq_curriculum_topic_id_unit (id, unit_id), INDEX idx_curriculum_topic_unit_status (unit_id, status), INDEX idx_curriculum_topic_parent (parent_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
