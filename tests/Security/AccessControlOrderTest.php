...
final class AccessControlOrderTest extends WebTestCase
{
    public function testPublicAuthRoutesRemainPublic(): void
    {
        ...
        foreach (['/kayit', '/kayit/ogrenci', '/kayit/veli', '/kayit/ogretmen', '/kayit/kurum', '/giris', '/kayit/eposta-kontrol', '/kayit/dogrulama-yeniden', '/sifremi-unuttum', '/sifremi-unuttum/eposta-kontrol', '/sifre-yenile', '/health', '/'] as $path) {
