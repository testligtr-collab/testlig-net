...
enum SecurityAuditAction: string
{
    ...
    case CommercialOfferRetired = 'commercial_offer_retired';
    case CommerceOrderCreated = 'commerce_order_created';
    case CommerceOrderCancelled = 'commerce_order_cancelled';
    case CommerceOrderExpired = 'commerce_order_expired';
    case CommerceOrderPaid = 'commerce_order_paid';
    case PaymentAttemptStarted = 'payment_attempt_started';
    ...
    case CommerceSubscriptionCancellationScheduled = 'commerce_subscription_cancellation_scheduled';
    case CommerceSubscriptionCancelled = 'commerce_subscription_cancelled';
    case CommerceSubscriptionExpired = 'commerce_subscription_expired';
